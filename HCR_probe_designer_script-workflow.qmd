...
fasta_file <- "./input/POLR1A_Homo_sapiens.fasta" 
target_name <- "polr1a"
...
GC_range <- c(0.4, 0.6)
pass_a_comp       <- TRUE
pass_c_comp       <- TRUE # stringent one
pass_a_stack      <- TRUE
pass_c_stack      <- TRUE
...
```{r}
## ---- Set params
blast_file <- "~/Documents/Data/BLAST/Hsap/Hsap_BLASTdb_ens99.fa"
tx2gene_csv <- "./data/BLAST/tx2gene/Hsap_tx2gene_ENSEMBL_v99.csv" # To convert tx_id to gene_id
