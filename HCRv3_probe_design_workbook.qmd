...
fasta_file <- "./input/Mmus_Actb-exon.fa" 
target_name <- "Mmus_Actb"
...
tx2gene_csv <- "./data/Mmus_tx2gene_ENSEMBL_v99.csv" # To convert tx_id to gene_id
...
max_blast_matches <- 7 # Max number of BLAST hits
